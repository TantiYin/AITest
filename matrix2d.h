...
inline void Matrix2::MatrixMultiply(Matrix &mIn)
{
	Matrix2::Matrix mat_temp;
...
inline void Matrix2::TransformVector2s(std::vector<Vector2> &vPoint)
{
...
inline void Matrix2::TransformVector2s(Vector2 &vPoint)
{
...
//create a transformation matrix
inline void Matrix2::Translate(double x, double y)
{
	Matrix mat;
...
//create a scale matrix
inline void Matrix2::Scale(double xScale, double yScale)
{
	Matrix2::Matrix mat;
...
//create a rotation matrix
inline void Matrix2::Rotate(double rot)
{
	Matrix2::Matrix mat;
...
inline void Matrix2::Rotate(const Vector2 &fwd, const Vector2 &side)
{
	Matrix2::Matrix mat;
